...
def apply_dark_theme():
    ...
    dark_theme_css = """
        <style>
            ...
            /* --- ADJUSTED STYLES FOR THEME SWITCHER --- */
            .title-container {
                display: flex;
                align-items: baseline; /* Use baseline for better text alignment */
                gap: 12px;
            }
            .theme-switcher-link {
                font-family: monospace;
                font-size: 1rem; /* Slightly smaller font */
                font-weight: 600; /* A touch bolder */
                ...
                border-radius: 6px;
                position: relative;
                top: -2px; /* Nudge up for perfect alignment */
...
def apply_light_theme():
    ...
    light_theme_css = """
        <style>
            ...
            /* --- ADJUSTED STYLES FOR THEME SWITCHER (Light Mode) --- */
            .title-container {
                display: flex;
                align-items: baseline; /* Use baseline for better text alignment */
                gap: 12px;
